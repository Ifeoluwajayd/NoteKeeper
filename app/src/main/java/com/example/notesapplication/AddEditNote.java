...
public class AddEditNote extends AppCompatActivity {
    ...
    private void saveNote() {
        ...
        if(title.trim().isEmpty() && description.trim().isEmpty()){
            Toast.makeText(this, "Please input a title and your note!",Toast.LENGTH_SHORT).show();
            return;
        }
        else if(title.trim().isEmpty()){
            Toast.makeText(this, "Please input a title to your Note!",Toast.LENGTH_SHORT).show();
            return;
        }
        else if(description.trim().isEmpty()){
            Toast.makeText(this, "Please no empty note will be saved!",Toast.LENGTH_SHORT).show();
            return;
        }
